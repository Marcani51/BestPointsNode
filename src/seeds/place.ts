...
async function seedPlaces() {
  ...
  const newPlace = await Promise.all(places.map(async (place) => {
    ...
    return {
        ...place,
        author: '6766b27d87968aa686000868',
        images: {
            url: 'Users\\macbookpro\\Projects\\yelpclone\\dist\\public\\images\\image-1735498140209-926659942.jpg',
            filename: 'image-1735498140209-926659942.jpg'
        },
        geometry: { ...geoData }
    }
}))
